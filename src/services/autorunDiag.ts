...
function runProbe(): void {
  try {
    console.info('[Perform6][diag] autorun blindspot probe', {
      ...
      ledPlaybackFile: readFileProbe('SD:/perform6-led-playback.json', 400),
      ledPlaybackStatus: readFileProbe('SD:/perform6-led-playback-status.json', 300),
      ledPlaybackStatusLed: readFileProbe(
        'SD:/perform6-led-playback-status-led.json',
        200,
      ),
      ledPlaybackStatusLed2: readFileProbe(
        'SD:/perform6-led-playback-status-led2.json',
        200,
      ),
      ledPlaybackStatusLed3: readFileProbe(
        'SD:/perform6-led-playback-status-led3.json',
        200,
      ),
      xtPlaybackFile: readFileProbe('SD:/perform6-xt-playback.json', 400),
      xtPlaybackStatus: readFileProbe('SD:/perform6-xt-playback-status.json', 300),
      ledBus: readFileProbe('SD:/perform6-led-bus.json', 200),
      xtBus: readFileProbe('SD:/perform6-xt-bus.json', 200),
